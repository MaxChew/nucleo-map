        ...
        <div class="px-6">
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                <div class="px-6 py-4 bg-gray-50 border-b border-gray-200">
                    ...
                    <p class="mt-1 text-sm text-gray-600">Create a new user account with basic information.</p>
                </div>
                ...
                <form method="POST" action="{{ route('admin.users.store') }}" class="px-6 py-4">
                    ...
                    <div class="mt-6">
                        ...
                        <p class="mt-1 text-sm text-gray-500">New users are active by default. Inactive users cannot log in to the system.</p>
                    </div>
